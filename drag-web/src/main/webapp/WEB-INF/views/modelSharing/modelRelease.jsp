                    ...
                    <div class="portlet light portlet-fit portlet-datatable ">
                        <div class="portlet-title">
                           ...
                           <!--  <div class="actions">
                            ...
                            <%--<div>--%>
                                <%--<input type="button" value="发布"  class="release"/>--%>
                            <%--</div>--%>

                            <div class="release_info">
                                    <div class="tell">&nbsp;&nbsp;选择目录</div>
                                    <div class="info">
                                    <%--<span>--%>
                                        <div class="tree well" id="treewell">
                                            <%--<ul>--%>
                                                <%--<li><input type="radio" checkedname="single"/><span  ><i class="icon-folder-open"></i>aaaaa</span></li>--%>
                                                <%--<li><input type="radio" name="single"/><span  ><i class="icon-folder-open"></i>aaaaaaa</span>--%>
                                                   <%--<ul><li><input type="radio" name="single"/><span ><i class='icon-minus-sign'></i></span></li>--%>
                                                       <%--<li><input type="radio" name="single"/><span ><i class='icon-minus-sign'></i></span></li>--%>
                                                       <%--<li><input type="radio" name="single"/><span ><i class='icon-minus-sign'></i></span></li>--%>
                                                   <%--</ul>--%>
                                               <%--</li>--%>
                                            <%--</ul>--%>
