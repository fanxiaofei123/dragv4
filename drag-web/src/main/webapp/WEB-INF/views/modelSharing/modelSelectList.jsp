                    ...
                    <div class="portlet light portlet-fit portlet-datatable ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">模型状态查看列表</span>
                            </div>
                                ...
                                <div style="float:right">状态：<select id="Audit">
                                         ...
                                         <option value="2">待审核</option>
                                          <option value="3">待发布</option>
                                           <option value="4">已经发布</option>
                                          <option value="6">审核不通过</option>
                                       </select>
                                <!-- <input type="text" name="name" id="workNameId"/> -->
                                <!-- <a href="javascript:;" class="btn green" onclick="selectWorkName()">搜索 <i class="fa fa-search"></i></a> -->
                                <a href="javascript:;" class="btn green" onclick="getModelUpdate(1)">搜索 <i class="fa fa-search"></i></a>
                            </div> 
                            </div>
                            ...
                            <div class="portlet-body">
                                ...
                                <form action="javascript:;" id="form_sample_1"  method="post" class="createSpace form-horizontal">
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input id="telNum" type="text" name="telNum" placeholder="请输入你的电话号码" size="35" class="form-control"/>
                                                <input id="wfid" type="hidden">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                            <input id="purpose" type="text" name="purpose" placeholder="请说明你的发布用途" size="35" class="form-control"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input id="name" type="text" name="name" placeholder="请输入你的姓名" size="35" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                               <textarea id="appExplain" rows="3"  name="appExplain" cols="64" placeholder="请简要填写应用说明"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                               <textarea id="apiExplain" rows="3" name="apiExplain" cols="64" placeholder="请简要填写调用API说明"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input id="testResult" type="text" name="testResult" placeholder="请填写模型制作者的测试结果" size="35" class="form-control" />
                                            </div>
                                        </div>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" class="yesClass btn green">提交</button>
...
<script type="application/javascript" src="${basePath}/content/js/modelSharing/modelSelectList.js"></script>
