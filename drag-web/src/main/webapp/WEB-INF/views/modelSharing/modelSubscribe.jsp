                    ...
                    <div class="portlet light portlet-fit portlet-datatable ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">模型订阅审核列表</span>
                            </div>
...
<script type="application/javascript" src="${basePath}/content/js/modelSharing/modelSubscribe.js"></script>
