...
<div class="menu_left_width">
    <div class="menu_name">
        ...
        <div class="creat_new">
            ...
            <i class="icon iconfont icon-moxing icon-green" ></i><span class="font-color">模板分类</span>
        </div>
    ...
    <div id="rMenu" class="rMenuShadow">
        <ul>
            <li id="addParent" onclick="return false;"><i class="icon iconfont icon-xinjianwenjianjia"></i>新建分类目录</li>
            <li id="creat" onclick="return false;"><i class="icon iconfont icon-xinjian3"></i>添加模板</li>
            <li id="edit" onclick="return false;"><span><i class="icon iconfont icon-bianji6"></i>重命名</span></li>
            <li id="remove" onclick="return false;"><span><i class="icon iconfont icon-cuo2"></i>删除模板</span></li>
            <li id="remove2" onclick="return false;"><span><i class="icon iconfont icon-cuo2"></i>删除分类目录</span></li>
        </ul>
    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.fn.zTree.init($("#treeDemo1"), setting1, zNodes1);//创建工作流
        $.fn.zTree.init($("#treeDemo2"), setting1, zNodes1);//查看工作流
        $.fn.zTree.init($("#treeDemo3"), setting1, zNodes1);//编辑工作流
