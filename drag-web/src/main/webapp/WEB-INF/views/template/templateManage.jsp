        ...
        <div class="page-content">
            ...
            <div class="page-bar shadowRadius">
                <div style="float: left">
                    <span  class="font-color">模板列表</span>
                    <span class="line">|</span>
                    <a href="#basic" data-toggle="modal" class="creat_model haveCheckBox"><span style="left: 8px"><i class="icon iconfont icon-jia1"></i></span><span>创建模板</span></a>
                    <a id="batchDelTemplate" onclick="deleteAllTemplate()" href="javascript:;" title="删除选中" class="creat_model"><span style="left: 8px"><i class="icon iconfont icon-shanchu2"></i></span><span>删除模板</span></a>
                </div>
                                ...
                                <form action="javascript:;"   id="form_sample_1" class="createFlow form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-2">名称：<span class="requiredRight required"> * </span></label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2">说明：<span class="requiredRight required">*</span></label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <p class="title_text selectMagNewtemplateKeyword"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2">关联工作流：<span class="requiredRight required"> * </span></label>
                                            <div class="col-md-10">
                                ...
                                <form action="javascript:;"   class="createFlow form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <%--</div>--%>
                                            <div class="col-md-10" >
                                            <input id="workFlowName" type="text" class=" noClickBack form-control"  >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <p class="title_text templateName" style="color: red"></p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <p class="title_text templateKeyword"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="updateDrawLabel control-label col-md-2"><span>上传封面图片：</span></label>
                                            <div class="input-group" style="padding: 0 15px">
                                                ...
                                                <span class="l-upimg input-group-addon" id="basic-addon4"><i class="icon iconfont icon-wenjianjia1"></i><input type="file" name="fileEdit"  id="fileEdit" accept="image/jpeg"/></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-2">关联工作流：</label>
                            ...
                            <div class="portlet-body">
                                ...
                                <form action="javascript:;"  class="updateFlow form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <input id="delTemplateCategoryId" name="delTemplateCategoryId" hidden>
                                    </div>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
