...
<div class="menu_left_width">
    <div class="menu_name">
        ...
        <div class="creat_new">
            ...
            <i class="icon iconfont icon-moxing icon-green" ></i><span class="font-color">数据挖掘分析</span>
        </div>
    ...
    <div id="rMenu" class="rMenuShadow">
        <ul>
            <li id="addParent" onclick="return false;"><i class="icon iconfont icon-xinjianwenjianjia"></i>新建挖掘分析项文件夹</li>
            <li id="creat" onclick="return false;"><i class="icon iconfont icon-xinjian3"></i>新建数据分析项</li>
