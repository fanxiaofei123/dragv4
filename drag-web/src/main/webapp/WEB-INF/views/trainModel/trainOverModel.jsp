...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <p id="titleFlowName" class="font-color">已训练模型</p>
            <div class="page-bar shadowRadius">

                <div style="float: left" ><a href="#basic" data-toggle="modal" id="deleteDiv" class="creat_model" onclick="deleteModelTitle()"><i class="icon iconfont icon-cuo"></i><span>删除模型</span></a></div>
...
<%--单个模型删除--%>
</div><div class="modal fade" id="deleteSingleModel" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
<!-- END CONTAINER -->
<%--重命名弹框--%>
<div class="modal fade " id="renameModel" tabindex="-1" role="basic" aria-hidden="true">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form ">
                            <div class="portlet-body">
                                ...
                                <form action="javascript:;" id="" class="updateFlow form-horizontal">
                                    <div class="form-body">
                                        <input type="text" class="form-control" id="fileName" placeholder="重新命名,最多20个字符长度" maxlength="20">
                                    </div>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-default font-color border-color" onclick="sureRename()">确定</button>
...
<script src="${basePath}/content/js/trainModel/trainOverModel.js" type="text/javascript"></script>
</body>
<script>
