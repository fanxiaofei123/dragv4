...
/**
 * 通过此类，可以继承的数据库连接池MyDruidDataSource,原生的DataSourceFactory只能创建DruidDataSource对象，
 *  不能转强转为子类MyDruidDataSource对象。
 */
public class MyDruidDataSourceFactory implements ObjectFactory {
...
//        DatabasePoolConnection.MyDruidDataSource dataSource = new DatabasePoolConnection.MyDruidDataSource();
        DatabasePoolConnection.MyDruidDataSource dataSource = new DatabasePoolConnection.MyDruidDataSource();
        config(dataSource, properties);
        return dataSource;
    }
