   ...
   // private static String userRootDir = DynamicVariable.HADOOP_HDFS_USER_DIR;
    ...
    public boolean createUserDir(String username) {
        ...
        try {
            ...
            close(null,null,null,null,fileSystem,null);
        }
        return false;
    }
...
//            IOUtils.copyBytes();
            ...
            close(in,null,null, out,fileSystem,null);
        }
        return true;
    }
    ...
    public byte[] readFileFromHdfs(String path,int readLength,String username){
        ...
        try {
            ...
            close(null,null,is,null,fileSystem,null);
        }
        return bytes;
    }
    ...
    public boolean downloadHdfsFile(String path,String localDir,String username){
        ...
        try {
            ...
            close(null,out,is,null,fileSystem,null);
        }
        return res;
    }
    ...
    private void close(BufferedInputStream bin,BufferedOutputStream bout,FSDataInputStream fin, FSDataOutputStream fout,FileSystem fileSystem,ByteArrayOutputStream bytestream) {
        try {
            if (bin != null) {
                bin.close();
            }
    ...
    public byte[] readFileFromHdfs(String path,String username){
        ...
        try {
            ...
            close(null,null,is,null,fileSystem,bytestream);
        }
        return bytes;
    }
     ...
     */
    @Override
    public String readLineFileFromHdfs(String path, String username) {
        FileSystem fileSystem = getFileSystem(username);
        ...
        try {
            ...
            InputStreamReader isr= new InputStreamReader(fileSystem.open(new Path(path)));
            String encoding=isr.getEncoding();
            br = new BufferedReader(new InputStreamReader(fileSystem.open(new Path(path)),"UTF-8"));
            String str = null;
            int i= 1;
