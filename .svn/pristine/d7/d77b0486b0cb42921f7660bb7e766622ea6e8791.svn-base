            ...
            <div class="page-bar">
                <ul class="page-breadcrumb" id="folder-navi">
                    <li onclick="showIndex(this)">
                        <i class="icon-home"></i>
                        <a class="font-blue-steel" href="javascript:;">私有数据</a>
                    </li>
                </ul>
            </div>
...
<script type="application/javascript" src="${basePath}/content/js/uploadData/uploadData.js"></script>
