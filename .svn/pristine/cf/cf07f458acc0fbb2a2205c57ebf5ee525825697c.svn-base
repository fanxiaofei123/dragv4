 ...
 * @Description: 对get post进行封装
 * 
 *   
 *  < path="/ssm-drag-web/drag/interface/login.do"/>
 *  
 *  
 *  < path="/ssm-drag-web/drag/interface/modify.do"/>
 *  
 *  
 *  < path="/ssm-drag-web/drag/interface/register.do"/>

 * @author: jiaonanyue

 * @date: 2016年12月30日 上午10:30:09
 */
public class HttpXmlClient {
    ...
    public static void main(String[] args) {
    	...
    	params.put("theme", "农村政策");  
    	params.put("limit", "7");*/  
    	/*String xml = HttpXmlClient.get("http://192.168.1.171:8080/govaff-web/ssm/hdfs/path.do"); 
